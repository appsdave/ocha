...
import { sortAgentsForDisplay, strikethrough, slugify, elapsed, formatDuration, badgeText, badgeColor, truncateTask, wrapText, parseWorkflowEvents, renderWorkflowOutput } from './tui-utils.js';
...
describe('formatDuration', () => {
  it('returns --:-- when startedAt is null', () => {
    assert.equal(formatDuration(null, '2026-01-01T00:05:00Z'), '--:--');
  });
  ...
  it('formats minutes and seconds', () => {
    assert.equal(formatDuration('2026-01-01T00:00:00Z', '2026-01-01T00:05:30Z'), '5m 30s');
  });
  ...
  it('handles large durations', () => {
    assert.equal(formatDuration('2026-01-01T00:00:00Z', '2026-01-01T01:30:15Z'), '90m 15s');
  });
});
